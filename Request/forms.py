...
class AddRequest(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'applicant_is_notified': CheckboxInput(attrs={'class': 'variable-input checkbox'}),
            'performer_is_notified': CheckboxInput(attrs={'class': 'variable-input checkbox'}),
            'operator_is_notified': CheckboxInput(attrs={'class': 'variable-input checkbox'}),
